...
@section('title','Merchant / Client Paid Invoice')
@section('content')
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Merchant / Client Paid Invoice  <small>(Agent)</small></h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                    <li class="breadcrumb-item active">
                        Merchant / Client Paid Invoice
                    </li>
                </ol>
            </div>
...
@endif
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{route('agent.payToMerchantClientCreate')}}" class="btn btn-primary btn-sm" /> Pay To Merchant/Client </a>
                    <div class="row" >
                       {{--  <div class="col-md-6">
                                        ...
                                        <tbody >
                                            @foreach ($invoices as $key=> $item)
                                                <tr>
                                                    <td>{{$key+1}}</td>
                                                    <td>
                                                        <a href="{{route('agent.payToMerchantClientViewDetails',$item->id)}}">
