...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Pay To Merchant/Client <small>(Agent)</small></h4>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('agent.payToMerchantClientCreateListStore')}}" method="POST">
                        @csrf
                    <div class="row" >
                        <div class="col-md-6">
...
@section('ajaxdropdown')
    ...
    <div id="payToMerchantClientCreateList" data-url="{{ route('agent.payToMerchantClientCreateList')}}"></div>
    {{--Making Cart--}}
    <script>
    ...
    <div id="getClientListparcelOwnerType" data-url="{{ route('agent.getClientListparcelOwnerType')}}"></div>
    <script>
    ...
    {{----Pagination by ajax-----}}
    <input type="hidden" id="getDataByPagination" data-url="{{route('agent.payToMerchantClientCreateList')}}" >
    <script>
