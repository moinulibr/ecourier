...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Branch Commission Paid Invoice  <small>(Agent)</small></h4>
                                        ...
                                        <tbody >
                                            @foreach ($invoices as $key=> $item)
                                                <tr>
                                                    <td>{{$key+1}}</td>
                                                    <td>
                                                        <a href="{{route('agent.paidBranchCommissionInvoiceListDetails',$item->id)}}">
                                                    ...
                                                    <td style="width:10%;">
                                                        <a href="{{route('agent.paidBranchCommissionInvoiceListDetails',$item->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i>View</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
