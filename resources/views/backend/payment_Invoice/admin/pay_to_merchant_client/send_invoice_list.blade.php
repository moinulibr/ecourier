...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Merchant / Client Paid Invoice  <small>(Admin)</small></h4>
...
@endif
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{route('admin.payToMerchantClientCreate')}}" class="btn btn-primary btn-sm" /> Pay To Merchant/Client </a>
                    <div class="row" >
                       {{--  <div class="col-md-6">
                                        ...
                                        <tbody >
                                            @foreach ($invoices as $key=> $item)
                                                <tr>
                                                    <td>{{$key+1}}</td>
                                                    <td>
                                                        <a href="{{route('admin.payToMerchantClientViewDetails',$item->id)}}">
