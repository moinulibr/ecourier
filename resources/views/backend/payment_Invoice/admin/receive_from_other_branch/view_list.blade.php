                                        ...
                                        <tbody >
                                            @foreach ($invoices as $key=> $order)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            echo receiveFromOtherBranchInvoiceAmount_HH($order->order_id,$from_branch_id,1,$pay_to_head_office_invoice_id);
                                                        @endphp
                                                    </td>
                                                    <td>
                                                        @php
                                                            echo receiveFromOtherBranchInvoiceAmount_HH($order->order_id,$from_branch_id,2,$pay_to_head_office_invoice_id);
                                                        @endphp
                                                    </td>
                                                    <td>
                                                        00.00
                                                    ...
                                                    <td>
                                                        @php
                                                            echo receiveFromOtherBranchInvoiceAmount_HH($order->order_id,$from_branch_id,4,$pay_to_head_office_invoice_id);
                                                        @endphp
                                                    </td>
                                                    <td>
