...
@section('title','Send Invoices List To Other Branch')
@section('content')
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Send Invoices List To Other Branch  <small>(Admin)</small></h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                    <li class="breadcrumb-item active">
                        Send Invoices List To Other Branch
                    </li>
                </ol>
            </div>
...
@endif
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                <a href="{{route('admin.sendToOthersBranchFromAdmin')}}" class="btn btn-primary btn-sm" />Send To Others Branch </a>
                    <div class="row" >
                       {{--  <div class="col-md-6">
                                        ...
                                        <tbody >
                                            @foreach ($invoices as $key=> $item)
                                                <tr>
                                                    <td>{{$key+1}}</td>
                                                    <td>
                                                        <a href="{{route('admin.sendInvoiceListDetails',$item->id)}}">
                                                    ...
                                                    <td style="width:10%;">
                                                        <a href="{{route('admin.sendInvoiceListDetails',$item->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i>View</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
