                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">
                                      <a href="{{ route('admin.role-menu-title-permition.index') }}">{{parentMenuAssignedPermissionList_HP}}</a>
                                </li>
                                ...
                                <div class="card height-auto mg-t-30">
                                    <div class="heading-layout1">
                                        <div class="item-title">
                                            <h5>  {{parentMenuPermissionCreate_HP}}</h5>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-12 form-group">
                                                ...
                                                <div class="col-xl-12 col-lg-12 col-12 form-group" style="margin-bottom:1%;">
                                                    <label for="" class="col-xl-3 col-lg-3 col-12"></label>
                                                        <input name="user_role_menu_title_id[]" value="{{ $item->id }}" {{ old('user_role_menu_title_id') == $item->id?'checked':'' }} type="checkbox" class="col-xl-2 col-lg-2 col-12 form-control clickable allMenuSelectByClass">
