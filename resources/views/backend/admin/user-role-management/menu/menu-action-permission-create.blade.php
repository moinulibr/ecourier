                    ...
                    <div class="row mb-2">
                        ...
                        <!---------------------Page Title------------------->
                            <h1 class="m-0 text-dark">
                               {{menuModuleRouteURLPermissionCreate_HP}} 
                            </h1>
                        <!---------------------Page Title------------------->
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="card height-auto mg-t-30">
                                <div class="heading-layout1">
                                    <div class="item-title">
                                        <h5>{{menuModuleRouteURLPermissionCreate_HP}}</h5>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-12 form-group">
                                            @foreach ($all_menu_titles as $key=> $allTitle)
                                                ...
                                                @foreach ($allTitle->menuTitleUseMenePermission ? $allTitle->menuTitleUseMenePermission:[] as $item)
                                                <div class="col-xl-12 col-lg-12 col-12 form-group" style="margin-bottom:1%;">
                                                    <label for="" class="col-xl-3 col-lg-3 col-12"></label>
                                                    <input name="user_role_menu_action_id[]" value="{{ $item->id }}" {{ old('user_role_menu_action_id') == $item->id?'checked':'' }} type="checkbox" class="col-xl-2 col-lg-2 col-12 form-control clickable childButtonSelected-{{$key}}">
