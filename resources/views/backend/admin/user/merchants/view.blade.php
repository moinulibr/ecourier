    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Merchant List</h4>
                        ...
                        <tbody>
                              @foreach($merchants as $merchant)
                               <tr>
                                   ...
                                   <td>{{ $merchant->useruid }}</td>
                                   <td>{{ $merchant->name }}</td>
                                   <td>{{ $merchant->phone }}</td>
                                   <td>{{ $merchant->email }}</td>
                                   <td>{{ $merchant->branch_id }}</td>
                                   <td>
                                  ...
                                  <td>
                                        ...
                                        <a href="{{ route('merchant.setting',$merchant->id) }}" class="btn btn-primary btn-sm">Setting</a>
                                       
                                       <a href="{{ route('merchant.destroy',$merchant->id) }}" class="btn btn-danger btn-sm" id="delete"> <i class="fa fa-trash"></i> Delete</a>



                        <!-- Button trigger modal -->
                                              <button type="button" class="btn btn-primary btn-sm " data-toggle="modal" data-target="#new_{{ $merchant->id }}"> <i class="fa fa-edit"></i>
                                               Edit
                                              </button>

                                              <!-- Modal -->
                                              <div class="modal fade" id="new_area_{{ $merchant->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                <div class="modal-dialog" role="document">
                                                  <div class="modal-content">
