...
@section('title','Order Cancel/Hold Parcel List')
@section('content')
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Cancel/Hold Parcel List  <small>(Agent)</small></h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                    <li class="breadcrumb-item active">Cancel/Hold Parcel List</li>
                </ol>
            </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('agent.storeCancelHoldParcelOrderList')}}" method="POST">
                        @csrf
                    <div class="row" >
                        <div class="col-md-6">
...
@section('ajaxdropdown')
    ...
    <div id="showCancelHoldParcelOrderList" data-url="{{ route('agent.showCancelHoldParcelOrderList')}}"></div>
    {{--Making Cart--}}
    <script>
        $(document).ready(function(){
            ...
            $(document).on('keyup change','.manpower_id_class,.order_assigning_status_id_class,.from_date_id_class,.to_date_id_class',function(e)
            {
                ...
                if (ctrlDown && (e.keyCode == vKey || e.keyCode == cKey)) return false;
                    var url = $('#showCancelHoldParcelOrderList').data("url");
                    var manpower_id                  =  getValueFromSelectOption('manpower_id_class');
    ...
    {{----Pagination by ajax-----}}
    <input type="hidden" id="getDataByPagination" data-url="{{route('agent.showCancelHoldParcelOrderList')}}" >
    <script>
            ...
            function getPagination(pageNumber){
                var createUrl = $('#showCancelHoldParcelOrderList').data("url");
