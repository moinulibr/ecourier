...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Order Delivered Parcel Amount Receive  <small>(Agent)</small></h4>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('agent.storeParcelAmountOrderList')}}" method="POST">
                        @csrf
                    <div class="row" >
                        <div class="col-md-6">
...
@section('ajaxdropdown')
    ...
    <div id="showParcelAmountOrderList" data-url="{{ route('agent.showParcelAmountOrderList')}}"></div>
    {{--Making Cart--}}
    <script>
