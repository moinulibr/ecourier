...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Cancel/Hold Parcel List  <small>(Admin)</small></h4>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.storeCancelHoldParcelOrderList')}}" method="POST">
                        @csrf
                    <div class="row" >
                        <div class="col-md-6">
...
@section('ajaxdropdown')
    ...
    <div id="showCancelHoldParcelOrderList" data-url="{{ route('admin.showCancelHoldParcelOrderList')}}"></div>
    {{--Making Cart--}}
    <script>
    ...
    {{----Pagination by ajax-----}}
    <input type="hidden" id="getDataByPagination" data-url="{{route('admin.showCancelHoldParcelOrderList')}}" >
    <script>
