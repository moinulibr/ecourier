...
@section('title','Send To Head Office Invoices')
@section('content')
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Send To Head Office  Invoices  <small>(Agent)</small></h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                    <li class="breadcrumb-item active">
                        Send To Head Office  Invoices
                    </li>
                </ol>
            </div>
...
@endif
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('agent.payToHeadOffice') }}" class="btn btn-primary btn-sm pull-right" /> Send To Head Office</a>
                    <div class="row" >
                       {{--  <div class="col-md-6">
                                        ...
                                        <tbody >
                                            @foreach ($invoices as $key=> $item)
                                                <tr>
                                                    <td>{{$key+1}}</td>
                                                    <td>
                                                        <a href="{{route('agent.payToHeadOfficeListShowSingle',$item->id)}}">
