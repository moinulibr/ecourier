...
@section('title','Merchant/Client Paid Invoice Details')
@section('content')
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Merchant/Client Paid Invoice Details  <small>(Admin)</small></h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                    <li class="breadcrumb-item active">Merchant/Client Paid Invoice Details</li>
                </ol>
            </div>
                                        ...
                                        <tbody >
                                            @foreach ($invoices as $key=> $order)
                                                <tr>
                                                    ...
                                                    <td>{{$order->orders?$order->orders->collect_amount:0}}</td>
                                                    <td>
