    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Admin Assign</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                        <li class="breadcrumb-item active">Amdin Parcel</li>
                    </ol>
                </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <form action="{{ route('admin.quickAssignParcelStoreFromCart') }}" method="post">
                        @csrf
                        <div class="row">
 ...
 <div id="quickAssignParcelAddCart" data-url="{{ route('admin.quickAssignParcelAddCart')}}"></div>
 <div id="quickAssignParcelExistCart" data-url="{{ route('admin.quickAssignParcelExistCart')}}"></div>
 <div id="quickAssignParcelRemoveSingleCart" data-url="{{ route('admin.quickAssignParcelRemoveSingleCart')}}"></div>
 <div id="quickAssignParcelRemoveCart" data-url="{{ route('admin.quickAssignParcelRemoveCart')}}"></div>
