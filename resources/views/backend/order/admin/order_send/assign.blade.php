        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <form action="{{ route('admin.send_quickAssignParcelStoreFromCart') }}" method="post">
                        @csrf
                        <div class="row">
 ...
 <div id="quickAssignParcelAddCart" data-url="{{ route('admin.send_quickAssignParcelAddCart')}}"></div>
 <div id="quickAssignParcelExistCart" data-url="{{ route('admin.send_quickAssignParcelExistCart')}}"></div>
 <div id="quickAssignParcelRemoveSingleCart" data-url="{{ route('admin.send_quickAssignParcelRemoveSingleCart')}}"></div>
 <div id="quickAssignParcelRemoveCart" data-url="{{ route('admin.send_quickAssignParcelRemoveCart')}}"></div>
