...
@push('title')
    Accepted Order Delivery Request List
@endpush
@section('content')
	<!-- start page title -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">All Accepted Order Delivery Request</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Manpower</a></li>
                        <li class="breadcrumb-item active">Accepted Order Delivery Request</li>
                    </ol>
                </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Accepted Order Delivery Request List 
