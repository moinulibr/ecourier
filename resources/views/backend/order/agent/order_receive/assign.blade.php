        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <form action="{{ route('agent.receive_quickAssignParcelStoreFromCart') }}" method="post">
                        @csrf
                        <div class="row">
 ...
 <div id="quickAssignParcelAddCart" data-url="{{ route('agent.receive_quickAssignParcelAddCart')}}"></div>
 <div id="quickAssignParcelExistCart" data-url="{{ route('agent.receive_quickAssignParcelExistCart')}}"></div>
 <div id="quickAssignParcelRemoveSingleCart" data-url="{{ route('agent.receive_quickAssignParcelRemoveSingleCart')}}"></div>
 <div id="quickAssignParcelRemoveCart" data-url="{{ route('agent.receive_quickAssignParcelRemoveCart')}}"></div>
