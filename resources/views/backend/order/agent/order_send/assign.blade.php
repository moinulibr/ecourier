        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <form action="{{ route('agent.send_quickAssignParcelStoreFromCart') }}" method="post">
                        @csrf
                        <div class="row">
                                    ...
                                    <div class="table-responsive dt-responsive">
                                        <table  class="table table-striped table-bordered nowrap">
                                            <thead>
                                                ...
                                                <th><small>Sending To (Branch)</small></th>
 ...
 <div id="quickAssignParcelAddCart" data-url="{{ route('agent.send_quickAssignParcelAddCart')}}"></div>
 <div id="quickAssignParcelExistCart" data-url="{{ route('agent.send_quickAssignParcelExistCart')}}"></div>
 <div id="quickAssignParcelRemoveSingleCart" data-url="{{ route('agent.send_quickAssignParcelRemoveSingleCart')}}"></div>
 <div id="quickAssignParcelRemoveCart" data-url="{{ route('agent.send_quickAssignParcelRemoveCart')}}"></div>
