...
@section('ajaxdropdown')   
    ...
    <div id="showManpowerOrderAssingedList" data-url="{{ route('agent.showManpowerOrderAssingedList')}}"></div>
    {{--Making Cart--}}
    <script>
        $(document).ready(function(){
            ...
            vKey = 86,
            cKey = 67;
            $(document).on('keyup change','.sender_id_class,.order_assigning_status_id_class,.from_date_id_class,.to_date_id_class',function(e)
            {
