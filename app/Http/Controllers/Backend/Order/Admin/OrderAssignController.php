...
class OrderAssignController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.order.admin.order_assigned_manpower.index',$data);
    }
    ...
    public function showManpowerOrderAssingedList(Request $request)
    {
       ...
       if($request->to_date)
       {
        ...
        return view('backend.order.admin.order_assigned_manpower.list',$data);                                          
    }
    ...
    public function printManpowerOrderAssingedList(Request $request)
    {
       ...
       if($request->to_date)
       {
        ...
        return view('backend.order.admin.order_assigned_manpower.print_popup',$data);                                          
        return view('backend.order.admin.order_assigned_manpower.list_print',$data);   
    }
