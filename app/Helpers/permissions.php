...
/*===========================================Route Setting==================================*/
    ...
    function accessableCheckForAdmin_HP($authRoleId)
    {
        if(userRoleIdSuperAdmin_HH == $authRoleId || userRoleIdAdmin_HH == $authRoleId)
        {
            return true;
        }else{
            return false;
    ...
    // merchant
    function accessableCheckForMerchant_HP($authRoleId)
    {
        if(userRoleIdMerchant_HH == $authRoleId)
        {
            return true;
        }else{
            return false;
    ...
    // agent
    function accessableCheckForAgent_HP($authRoleId)
    {
        if(userRoleIdAgentAdmin_HH == $authRoleId)
        {
            return true;
        }else{
            return false;
