...
class CreateHeadOfficePayToBranchInvoiceDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('head_office_pay_to_branch_invoice_details', function (Blueprint $table) {
            $table->id();
            $table->integer('head_office_pay_to_branch_invoice_id')->nullable();
    ...
    {
        Schema::dropIfExists('head_office_pay_to_branch_invoice_details');
    }
}
