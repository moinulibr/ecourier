...
class CreatePayToHeadOfficeInvoicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pay_to_head_office_invoices', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pay_to_head_office_invoices');
    }
}
