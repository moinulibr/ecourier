...
class CreatePayToManpowerCommissionInvoicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pay_to_manpower_commission_invoices', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pay_to_manpower_commission_invoices');
    }
}
