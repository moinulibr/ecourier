...
class CreateHeadOfficePayToBranchInvoicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('head_office_pay_to_branch_invoices', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('head_office_pay_to_branch_invoices');
    }
}
